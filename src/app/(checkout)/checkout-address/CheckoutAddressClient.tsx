...
import checkoutAddressStyle from "./CheckoutAddressClient.css";
import Button from "@/components/button/Button";
import Heading from "@/components/heading/Heading";

const CheckoutAddressClient: React.FC = () => {
  ...
  return (
    <section className={checkoutAddressStyle.checkout}>
      <Heading title="상세주문" />
      <form onSubmit={handleSubmit}>
        <div className={checkoutAddressStyle.card}>
          <h3>배송 주소</h3>
