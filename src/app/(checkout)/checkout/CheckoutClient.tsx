...
import checkoutStyle from "./CheckoutClient.css";
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    tossPayment
      .requestPayment("카드", {
        ...
        orderId: Math.random().toString(36).slice(2), // 랜덤으로 넣은 값.
        orderName: "주문", // 상품 이름을 넣어도 됨
      })
    ...
    <section>
      <div className={checkoutStyle.checkout}>
        ...
        <form onSubmit={handleSubmit}>
          <div className={checkoutStyle.card}>
            <CheckoutForm />
          </div>
          <div>
